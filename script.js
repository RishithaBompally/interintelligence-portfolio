...
function showProjectDetails(project) {
    ...
    // Populate the popup with project info
    const details = projectDetails[project];
    document.getElementById("projectTitle").innerText = details.title;
    document.getElementById("projectDescription").innerText = details.description;
    document.getElementById("projectTools").innerText = details.tools;
